...
import { getTimeDisplayValue } from "entities/cinemaSession/lib";
...
export const ListCinemaSessions: React.FC<IListCinemaSessionsProps> = ({
  movieSessions,
  bookSession,
  selected,
}) => {
